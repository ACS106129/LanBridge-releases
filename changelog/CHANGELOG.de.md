...
- Beta-Versionen lassen sich in den Einstellungen einschalten.
- Beta aus installiert wieder die offizielle Version.
- Patches werden in der App verwahrt und verwaltet.
- Warcraft III wird am Installationsort gefunden.

### Geändert

- Jeder Patch zeigt sein Aktualisierungsdatum.

### Behoben

- Das VPN bleibt aktiv, wenn die App im Hintergrund ist.
- Beenden lässt OpenVPN nicht mehr laufen.
- Neuigkeiten zeigen jede übersprungene Version.

## [0.5.34] - 2026-09-26

### Geändert

- Das Protokoll zeigt die neueste Zeile oben.
- Nur Bedienelemente der aktuellen Auswahl werden gezeigt.
- Der Übersetzungspatch hat eine eigene Karte.
- Nur Klicks auf Schaltflächen und Menüs erzeugen Töne.

### Behoben

- Eine falsche Patch-Datei ändert den Status nicht mehr.
...
- DMM Game Player installieren und starten in einem Schritt.
- Sortieren nach Land, Tempo, Latenz, Sitzungen.
- Profile merken sich ihr Tempo.
- Download zeigt Tempo und Restzeit.

### Geändert

- Tunnel-Seiten stehen beim VPN-Profil.
- Updates laden deutlich schneller.
- Jede Hilfe ist ein einziger Satz.

### Behoben

- Ein getrennter Tunnel gilt nicht mehr als bereit.
- Gleiche Profile werden nur einmal gespeichert.
- Entfernen-Knopf nicht mehr unter der Leiste.
