...
- Versões beta podem ser ativadas nas Configurações.
- Desativar a beta reinstala a versão oficial.
- Patches são guardados e geridos no app.
- O Warcraft III é encontrado onde estiver instalado.

### Alterado

- Cada patch mostra quando foi atualizado.

### Corrigido

- A VPN continua ativa com o app em segundo plano.
- Parar não deixa mais o OpenVPN rodando.
- As novidades listam cada versão pulada.
...
- O modo DMM carrega ou remove patches de tradução.

### Alterado

- Registos em texto simples, uma conclusão por linha.

### Corrigido

- Um servidor mudo é indicado como causa.

## [0.5.32] - 2026-09-24

### Adicionado

- DMM Game Player instala e inicia num só passo.
- Ordenar por país, velocidade, latência ou sessões.
- Perfis guardam a velocidade de origem.
- O download mostra velocidade e tempo.

### Alterado

- Sites do túnel junto ao perfil VPN.
- Atualizações baixam muito mais rápido.
- Cada ajuda é uma só frase.

### Corrigido

- Um túnel caído já não aparece como pronto.
- O mesmo perfil é guardado só uma vez.
- O botão remover não fica sob a barra.

## [0.5.31] - 2026-09-23

### Adicionado

- Uma lista de sites da DMM pronta a usar.

### Alterado

- Só o início de sessão passa pelo túnel; o jogo já não fica lento.
- A sessão já não persegue a aplicação até outro processo.
- Se a aplicação já está aberta, é essa que se usa em vez de abrir outra.

### Corrigido

- O túnel já não morre em silêncio após uma reconexão.
- O endereço de início de sessão já não se perde entre duas consultas.
- Uma quebra breve já não reinicia o túnel.
