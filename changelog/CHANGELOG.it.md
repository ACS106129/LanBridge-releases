...
- Le versioni beta si attivano nelle Impostazioni.
- Disattivare la beta reinstalla la versione ufficiale.
- Le patch sono conservate e gestite nell’app.
- Warcraft III viene trovato dove è installato.

### Modificato

- Ogni patch mostra quando è stata aggiornata.

### Corretto

- La VPN resta attiva con l’app in background.
- Fermarsi non lascia più OpenVPN in esecuzione.
- Le novità elencano ogni versione saltata.

## [0.5.34] - 2026-09-26

### Modificato

- Il log mostra in alto la riga più recente.
- Si vedono solo i controlli usati dalle scelte attuali.
- La patch di traduzione ha una sua scheda.
- Suonano solo i clic su pulsanti e menu.

### Corretto

- Scegliere un file che non è una patch non cambia lo stato.

## [0.5.33] - 2026-09-25

### Aggiunto

- La modalità DMM carica o rimuove patch di traduzione.

### Modificato

- Log in chiaro, una conclusione per riga.

### Corretto

- Un server muto viene indicato come causa.

## [0.5.32] - 2026-09-24

### Aggiunto

- DMM Game Player si installa e avvia in un passo.
- Ordina per paese, velocità, latenza o sessioni.
- I profili ricordano la velocità d'origine.
- Il download mostra velocità e tempo.

### Modificato

- I siti del tunnel accanto al profilo VPN.
- Gli aggiornamenti scaricano molto più veloci.
- Ogni aiuto è una sola frase.

### Corretto

- Un tunnel caduto non risulta più pronto.
- Lo stesso profilo si salva una volta sola.
- Il pulsante rimuovi non è sotto la barra.

## [0.5.31] - 2026-09-23

### Aggiunto

- Un elenco di siti DMM già pronto.

### Modificato

- Solo l'accesso passa dal tunnel; il gioco non viene più rallentato.
- La sessione non insegue più l'app in un altro processo.
- Se l'app è già aperta si usa quella, senza avviarne una seconda.

### Corretto

- Il tunnel non muore più in silenzio dopo una riconnessione.
- L'indirizzo di accesso non si perde più tra due risoluzioni.
- Un calo breve non riavvia più il tunnel.
...
- **L'aggiornamento è più piccolo di 38,8 MB**: lo stack di apprendimento automatico del Windows App SDK, onnxruntime e DirectML, viaggiava dentro una VPN per applicazione che non lo chiama mai.
- **Una pubblicazione non è più visibile finché non sono allegati tutti i suoi installer**, ed è per questo che la 0.5.27 ha proposto un installer tedesco a un'interfaccia cinese: è stata pubblicata con un solo file caricato e il resto ancora in corso, e l'applicazione si accorge di una nuova versione in circa un minuto.
