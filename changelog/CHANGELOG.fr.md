...
- Les versions bêta s’activent dans les paramètres.
- Désactiver la bêta réinstalle la version officielle.
- Les patchs sont gardés et gérés dans l’app.
- Warcraft III est trouvé là où il est installé.

### Modifié

- Chaque patch affiche sa date de mise à jour.

### Corrigé

- Le VPN reste actif quand l’app est en arrière-plan.
- L’arrêt ne laisse plus OpenVPN tourner.
- Les nouveautés listent chaque version sautée.
...
- Le mode DMM charge ou retire un patch de traduction.

### Modifié

- Journaux en clair, une conclusion par ligne.

### Corrigé

- Un serveur muet est désigné comme cause.

## [0.5.32] - 2026-09-24

### Ajouté

- DMM Game Player s'installe et se lance en une étape.
- Tri par pays, débit, latence ou sessions.
- Les profils gardent leur débit d'origine.
- Le téléchargement affiche débit et durée.

### Modifié

- Les sites du tunnel près du profil VPN.
- Les mises à jour arrivent bien plus vite.
- Chaque aide tient en une phrase.

### Corrigé

- Un tunnel coupé n'apparaît plus comme prêt.
- Un même profil n'est stocké qu'une fois.
- Le bouton retirer n'est plus sous la barre.
